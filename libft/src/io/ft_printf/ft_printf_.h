...
int32_t					set_prefix_fp(t_ptf_info *info, char sign,
						int_fast32_t val_len);
int32_t					set_prefix_num(t_ptf_info *info, char sign,
						int_fast16_t base, int_fast32_t val_len);
